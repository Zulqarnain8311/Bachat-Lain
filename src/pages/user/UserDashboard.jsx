...
const UserDashboard = () => {
  ...
  // Use context for loading state and fetching orders
  const context = useContext(myContext);
  const { loading, getAllOrder = [] } = context; // Default to empty array if undefined
        ...
        {user ? (
          <>
            ...
            <div className="bottom mx-auto my-4 max-w-6xl px-2 md:my-6 md:px-0">
              ...
              {/* Display Orders if not loading and data exists */}
